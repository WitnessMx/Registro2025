...
$boton_play.addEventListener("click", function() {
    ...
    obtenerDispositivos().then(dispositivos => {
        ...
        if (dispositivosDeVideo.length > 0 && dispositivosDeVideo.length < 2) {
...
$boton_guardar.addEventListener("click",function(){
                ...
                if (CAPTURAR_NUEVA_IMAGEN==true) {
                    //if($idGage.value!=''){
                        ...
                        var id=document.getElementById("id_gage");
                        ...
                        let url = "https://script.google.com/macros/s/AKfycbxpXyg8ZTHa0nfZks5U79D33Y1FQFOqzYOcsMsBdCMgA_Bb2bWz8qraH-S-06-onQJL/exec";
